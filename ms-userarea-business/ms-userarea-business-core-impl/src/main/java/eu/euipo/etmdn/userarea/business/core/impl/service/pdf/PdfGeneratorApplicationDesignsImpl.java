/*
 * $Id:: PdfGeneratorApplicationDesignsImpl.java 2021/04/02 02:26 tantonop
 *
 *        . * .
...
@Data
@AllArgsConstructor
public class PdfGeneratorApplicationDesignsImpl implements PdfGenerator {

    private static final String FILENAME = "designs.pdf";
    ...
    public PdfTemplateType getPdfTemplateType() {
        if(isDraft()){
            return PdfTemplateType.DESIGN_DRAFT;
        }
        return PdfTemplateType.DESIGN;
    }
