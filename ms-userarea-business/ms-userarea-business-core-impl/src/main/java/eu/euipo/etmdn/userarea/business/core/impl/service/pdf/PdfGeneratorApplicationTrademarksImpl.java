/*
 * $Id:: PDFGeneratorApplicationTrademarksImpl.java 2021/04/02 01:49 tantonop
 *
 *        . * .
...
@Data
@AllArgsConstructor
public class PdfGeneratorApplicationTrademarksImpl implements PdfGenerator {

    private static final String FILENAME = "trademarks.pdf";
    ...
    public PdfTemplateType getPdfTemplateType() {
        if(isDraft()){
            return PdfTemplateType.TRADEMARK_DRAFT;
        }
        return PdfTemplateType.TRADEMARK;
    }
